...
public class StreamingActivity extends AppCompatActivity implements SurfaceHolder.Callback, Session.Callback, RtspClient.Callback{
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        String servidor = intent.getStringExtra("servidor");
        ...
        mClient.setServerAddress(servidor, Integer.parseInt(puerto));
